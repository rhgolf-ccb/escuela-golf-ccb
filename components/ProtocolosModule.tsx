              ...
              {categorias.map((cat) => (
                <div key={cat.label ?? "_"}>
                  ...
                  <div className="space-y-3">
                    {cat.tests.map((t) => (
                      <TestCard key={t.codigo} test={t} editing={editing} showEdad={showEdad} tipo={activeNav.tipo}
...
function TestCard({ test, editing, showEdad, tipo, uploading, onChange, onBenchmarkChange, onAddBenchmark, onRemoveBenchmark, onUploadFoto }: {
  test: TestFull; editing: boolean; showEdad: boolean; tipo: "tecnico" | "fisico"; uploading: boolean;
    ...
    <div className="border border-gray-100 rounded-xl overflow-hidden bg-white">
      <div className="px-4 py-3 bg-gray-50">
        <div className="flex items-center gap-2 mb-1">
          <span className="text-xs font-semibold px-1.5 py-0.5 rounded shrink-0" style={{ backgroundColor: "#E6F1FB", color: "#185FA5" }}>{test.codigo}</span>
          {editing ? (
